...
namespace Camps1te::Editor::MiscExamples::MapView {
    ...
    public:
        ...
        void updateHighlight() {
            auto* item = this->scene()->property("highlight").value<QGraphicsRectItem*>();
            if (item != nullptr) {
